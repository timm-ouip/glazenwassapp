...
import { aanmeldAdres, aanmeldLink, fetchAanmeldingen } from "@/lib/aanmeldingen";
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              <Input id="aanmeldlink" readOnly value={link} className="font-mono text-[12.5px]" />
              <Button
                type="button"
                variant="outline"
                className="shrink-0 rounded-full"
          ...
          <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-end">
            ...
            <div className="space-y-2">
              <p className="max-w-[34ch] text-[12.5px] text-muted-foreground">
                Print de QR-code op een flyer of zet hem op de bus. Wie hem scant komt direct op
                jouw pagina.
              </p>
              <div className="flex gap-2">
                <Button
