...
export function Gesprek({
  ...
  const gesprek = useQuery({
    queryKey: ["gesprek", berichtId],
    queryFn: () => fetchGesprek(berichtId),
  });
              ...
              <li key={m.id}>
                ...
                >
                  <span
                    className={cn(
                      "mt-0.5 shrink-0",
                      uit ? "text-tint-blauw-ink" : "text-muted-foreground",
                    )}
                  >
                    {uit ? (
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="flex gap-2">
                      <span className="min-w-0 flex-1 truncate font-medium">
                        ...
                        {deze && (
                          <span className="font-normal text-muted-foreground"> · deze mail</span>
                        )}
                      </span>
