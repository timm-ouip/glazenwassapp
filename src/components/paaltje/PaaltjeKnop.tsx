    ...
    <>
      <button
        ...
        className={cn(
          ...
          "flex size-16 items-center justify-center rounded-full shadow-[0_4px_14px_oklch(0.4_0.02_70/25%)] transition-transform hover:scale-105 active:scale-95 print:hidden",
          open && "hidden",
        )}
      >
        <PaaltjeLui beweegt className="size-16 overflow-hidden rounded-full" />
        {aantal > 0 && (
